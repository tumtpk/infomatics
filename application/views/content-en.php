      ...
      <div class="row">
         ...
         <div class="col-sm-12 col-md-6">
            <div class="service-item wow fadeInUpQuick animated" data-wow-delay=".8s">
               ...
               <p>
               <a href="<?php echo site_url("main/undergraduate")?>">Programs</a>
		...
		<div class="row">
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="blog-item-wrapper wow fadeIn" data-wow-delay="0.3s">            
         		...
         		<h3 class="small-title mb-3 wow fadeInUp" data-wow-delay="0.3s"> 10 Reasons to Study at School of Informatics </h3>
                    <p>
