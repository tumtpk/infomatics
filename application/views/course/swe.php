              ...
              <div class="col-md-3 card">
                ...
                <div class="service-item wow fadeInUpQuick animated animated" data-wow-delay=".5s" style="visibility: visible;-webkit-animation-delay: .5s; -moz-animation-delay: .5s; animation-delay: .5s;">
                  ...
                  <p class="text-left">
                    ...
                    3.ทดลองใช้เครื่องมือในการขับเคลื่อนการพัฒนาซอฟต์แวร์ด้วยการทดสอบ (Test-driven Software Development) <br/>
                  </p>
                </div>
                <!-- Service-Block-1 Item Ends -->
              </div>
              <div class="col-md-3 card">
                ...
                <div class="service-item wow fadeInUpQuick animated animated" data-wow-delay=".5s" style="visibility: visible;-webkit-animation-delay: .5s; -moz-animation-delay: .5s; animation-delay: .5s;">
                  ...
                  <p class="text-left">
                    ...
                    2.รู้จักคอมพิวเตอร์กราฟิก (Computer Graphics) และเขียนโปรแกรมประยุกต์กราฟิก<br/>
                    3.ทดลองการประยุกต์ใช้คอมพิวเตอร์วิทัศน์ (Computer Vision) เพื่อการสกัดคุณลักษณะ การวิเคราะห์ภาพ และการวิเคราะห์การเคลื่อนที่ของวัตถุ <br/>
                  </p>
                </div>
                <!-- Service-Block-1 Item Ends -->
              </div>
              ...
              <div class="item">
                <div class="testimonial-inner">
                  ...
                  <div class="testimonial-content">
                    <a href="#">
                      	วิศกรซอฟต์แวร์ (Software Engineer)
                    </a>
                  </div>
                </div>
              </div>
